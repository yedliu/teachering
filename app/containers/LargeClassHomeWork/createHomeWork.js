...
export class CreateHomeWork extends React.PureComponent { // eslint-disable-line react/prefer-stateless-function
          ...
          <QuestionInfoWrapper bgTransparent key={index} homeworkStep={homeworkStep}>
            ...
            <ControlButtons analysisShow={showAnalysis} hasChild={hasChild} showChild={showChild} className="buttons">
              <PromptText>
                ...
                <SplitSpan />
                题类：{ratingList[item.get('comprehensiveDegreeId') || 1].name || ''}
                <SplitSpan />
  ...
  makeHomeworkStep(step) {
    ...
    const homeworkScene = createHomeworkStepParams.get('homeworkScene');
    const homeworkName = createHomeworkStepParams.get('homeworkName');
      ...
      case 1: // eslint-disable-line
        ...
        res = (<FlexRow style={{ flex: 1, position: 'relative' }}>
          ...
          <StepOneRightWrapper>
            <SearchQesWrapper>
              <QuestionSearchData
                source="LargeClassHomeWork"
                searchStyle={{ wrapper: { width: '100%' }, item: { height: 35 }}}
                whoseShow={['area', 'grade', 'year', 'term', 'paperType', 'examType', 'difficulty', 'input', 'questionType', 'search']}
            ...
            <SkepMsgBoxWrapper>
              <HomeworkSkepMsgBox>
                ...
                <SkepControlWrapper>
                  ...
                  {/* <SkepControlItem
                    style={{ color: mainColorBlue }} onClick={() => {
                      ...
                      if (homeworkSkepErrorList.length <= 0) {
                        ...
                        message.warning(`第 ${msg.index + 1} 题，${msg.value}，请到编辑页面移除有问题的题目再发布。`);
                      }
                    }}
                  >一键发布</SkepControlItem> */}
                </SkepControlWrapper>
              </HomeworkSkepMsgBox>
            </SkepMsgBoxWrapper>
          </StepOneSession>
        ...
        res = (<FlexColumn style={{ width: '100%', height: '100%', background: '#fff' }}>
          <AIHomework
            ...
            AIHomeworkParams={createHomeworkStepParams
              ...
              .set('homeworkScene', homeworkScene)
  ...
  makeHeaderforStandHw() {
    ...
    switch (homeworkStep) {
      ...
      default:
        res = (<HeaderTitle>
          <HomeworkWrapperTitleItem selected>新建作业</HomeworkWrapperTitleItem>
          <PlaceHolderBox />
