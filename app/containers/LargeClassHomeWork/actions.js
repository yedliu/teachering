...
// 课程内容
export function getCourseContent(term, course) {
  return {
    type: ACTIONS.GET_COURSE_CONTENT,
    term,
    course
  };
}
// 课程类型
export function findSystemDict(param, defaultName) {
  return {
    type: ACTIONS.FIND_SYSTEM_DICT,
    param,
    defaultName
  };
}
...
export function getCourseListAction(courseContentId) {
  return {
