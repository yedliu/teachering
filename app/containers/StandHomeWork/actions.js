...
export function getGradeListAction(phaseId, allowSubject) {
  return {
...
export function getSubjectListAction(allowSubject) {
  return {
...
export function saveStandHomeworkAction(params) {
  return {
...
export function getPreviewHomeworkDataListAction(item) {
  return {
...
export function setClassTypeCode(code) {
  return {
    type: ACTIONS.CLASS_TYPE_CODE,
    code
  };
}
export function shelfOrObtainedAction(id, state) {
  return {
    type: ACTIONS.SHELF_OR_OBTAINED_ACTION,
    id,
    state,
  };
}
export function saveReEditHomeworkAction(item) {
  return {
    type: ACTIONS.SAVE_RE_EDIT_HOMEOWK_ACTION,
    item
  };
}

export function setSliderState(state) {
  return {
    type: ACTIONS.SET_SLIDER_STATE,
    state
  };
}
