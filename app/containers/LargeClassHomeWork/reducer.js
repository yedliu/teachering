...
const initialState = fromJS({
  ...
  prviewSelectObj: {
    ...
    courseTypeList: [],
    termList: [],
    courseContentMap: {}, // 课程内容
    courseSystemMap: {},// 课程体系map
    treeList: [],
    standHomeWorkList: [],
...
function largeClassHomeWorkReducer(state = initialState, action) {
  switch (action.type) {
    case DEFAULT_ACTION:
      return state;
    ...
    case INIT_DATA_WHEN_CLOSE_ACTION:
...
export default largeClassHomeWorkReducer;
